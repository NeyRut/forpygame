...
def main_menu():
    ...
    button_normal = load_image("button_normal.png", 200, 50)
    button_hover = load_image("button_hover.png", 200, 50)

    buttons = [
        {"text": "Новая игра", "rect": pygame.Rect(300, 200, 200, 50), "action": "new_game"},
        {"text": "Настройки", "rect": pygame.Rect(300, 300, 200, 50), "action": "settings"},
        {"text": "Выход", "rect": pygame.Rect(300, 400, 200, 50), "action": "exit"}
    ]
    ...
    while True:
        ...
        for button in buttons:
            ...
            if button["rect"].collidepoint(mouse_x, mouse_y):
                screen.blit(button_hover, button["rect"].topleft)
            else:
                screen.blit(button_normal, button["rect"].topleft)


            draw_text(screen, button["text"], 20, button["rect"].x + 50, button["rect"].y + 15, BLACK)
